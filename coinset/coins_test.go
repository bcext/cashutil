...
import (
	...
	"github.com/bcext/cashutil/coinset"
...
func NewCoin(index int64, value cashutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = cashutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = cashutil.NewTxFromBytes(testSimpleCoinTxBytes)
