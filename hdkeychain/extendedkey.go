...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := cashutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*cashutil.AddressPubKeyHash, error) {
	pkHash := cashutil.Hash160(k.pubKeyBytes())
	return cashutil.NewAddressPubKeyHash(pkHash, net)
}
